...
#if defined(MCUBOOT_USE_BL_CRYPTO) && defined(MCUBOOT_USE_TINYCRYPT) 
    #error "Cannot define both BL_CRYPTO and TINYCRYPT"
#endif

#if !defined(MCUBOOT_USE_MBED_TLS)  &&\
	!defined(MCUBOOT_USE_TINYCRYPT) &&\
	!defined(MCUBOOT_USE_BL_CRYPTO)
    #error "One of MBED_TLS or TINYCRYPT or BL_CRYPTO must be defined"
#endif
